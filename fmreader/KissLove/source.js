...
Object.defineProperty(exports, "__esModule", { value: true });
exports.KissLove = exports.KissLoveInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const FMReader_1 = require("../FMReader");
const KissLovePraser_1 = require("./KissLovePraser");
const KissLove_DOMAIN = 'https://klmag.net';
exports.KissLoveInfo = {
    version: '3.0.0',
    name: 'KissLove',
...
class KissLove extends FMReader_1.FMReader {
    constructor() {
        super(...arguments);
        this.baseUrl = KissLove_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.JAPANESE;
        this.requestPath = 'manga-list.html';
        this.parser = new KissLovePraser_1.KissLoveParser();
        this.adult = true;
        this.userAgent = '';
    }
    parseStatus(str) {
...
exports.KissLove = KissLove;

},{"../FMReader":45,"./KissLovePraser":48,"paperback-extensions-common":7}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KissLoveParser = void 0;
const FMReaderParser_1 = require("../FMReaderParser");
class KissLoveParser extends FMReaderParser_1.Parser {
    parseTags($) {
        var _a;
        const genres = [];
...
exports.KissLoveParser = KissLoveParser;
