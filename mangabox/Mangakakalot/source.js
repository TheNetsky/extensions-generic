...
},{"./MangaBoxHelper":55,"./MangaBoxParser":56,"./MangaBoxSettings":57,"paperback-extensions-common":13}],55:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"entities":5,"paperback-extensions-common":13}],57:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
class Mangakakalot extends MangaBox_1.MangaBox {
    constructor() {
        super(...arguments);
        this.baseUrl = MANGAKAKALOT_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.ENGLISH;
        this.mangaListPath = 'manga_list';
        this.mangaListSelector = 'div.truyen-list div.list-truyen-item-wrap';
        this.mangaListSubtitleSelector = 'a.list-story-item-wrap-chapter';
    }
    parseTagUrl(url) {
        var _a, _b;
        return (_b = (_a = url.split('category=').pop()) === null || _a === void 0 ? void 0 : _a.split('&')[0]) === null || _b === void 0 ? void 0 : _b.replace(/[^0-9]/g, '');
    }
    mangaListPagination(url, page) {
    ...
    getTags() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tag of $('tbody a').toArray()) {
                const label = $(tag).text().trim();
                const id = this.parseTagUrl((_a = $(tag).attr('href')) !== null && _a !== void 0 ? _a : '');
                if (!id || !label)
                    continue;
                arrayTags.push({ id: id, label: label });
            }
            ...
            if (query.includedTags) {
                const request = createRequestObject({
                    url: new MangaBoxHelper_1.URLBuilder(this.baseUrl)
                        ...
                        .addQueryParameter('category', (_b = query.includedTags[0]) === null || _b === void 0 ? void 0 : _b.id)
                        .addQueryParameter('page', page)
                        .buildUrl(),
                    method: 'GET'
                });
                const response = yield this.requestManager.schedule(request, 1);
                const $ = this.cheerio.load(response.data);
                results = MangaBoxParser_1.parseMangaList($, this);
                metadata = !MangaBoxParser_1.isLastPage($) ? { page: page + 1 } : undefined;
            }
            else {
                const request = createRequestObject({
                    url: new MangaBoxHelper_1.URLBuilder(this.baseUrl)
                        ...
                        .addPathComponent((_d = (_c = query.title) === null || _c === void 0 ? void 0 : _c.replace(/[^a-zA-Z0-9 ]/g, '').replace(/ +/g, '_').toLowerCase()) !== null && _d !== void 0 ? _d : '')
                        .addQueryParameter('page', page)
                        .buildUrl(),
                    method: 'GET'
                });
                ...
                for (const manga of $('div.panel_story_list div.story_item').toArray()) {
                    ...
                    const id = $('a', manga).first().attr('href');
                    const image = (_e = $('img', manga).first().attr('src')) !== null && _e !== void 0 ? _e : 'https://i.imgur.com/GYUxEX8.png';
                    ...
                    results.push(createMangaTile({
                        id: id,
                        image: image,
                        title: createIconText({ text: MangaBoxParser_1.decodeHTMLEntity(title) }),
                        subtitleText: createIconText({ text: subtitle }),
                    }));
                }
                metadata = !MangaBoxParser_1.isLastPage($) ? { page: page + 1 } : undefined;
...
},{"../MangaBox":54,"../MangaBoxHelper":55,"../MangaBoxParser":56,"paperback-extensions-common":13}]},{},[58])(58)
});
