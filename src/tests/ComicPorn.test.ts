...
import { Bentai } from '../Bentai'
import { ComicPorn } from '../ComicPorn/ComicPorn'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('ComicPorn Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Bentai = new ComicPorn(cheerio)
   ...
   */
    ...
    it('Testing home page results for featured titles', async () => {
        const results = await wrapper.getViewMoreItems(source, 'homepage', {}, 1)
