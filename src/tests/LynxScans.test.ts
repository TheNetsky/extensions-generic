...
describe('LynxScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Genkan = new LynxScans(cheerio)
   ...
   */
    const mangaId = '248175-the-story-of-a-low-rank-soldier-becoming-a-monarch' // 975061-the-pampered-regent-of-the-richest-woman
    ...
    it('Testing Notifications', async () => {
        const updates = await wrapper.filterUpdatedManga(source, new Date('2022-5-5'), [mangaId])
