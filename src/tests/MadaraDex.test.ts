...
import { MadaraDex } from '../MadaraDex/MadaraDex'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('MadaraDex Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new MadaraDex(cheerio)
     ...
     */
    const mangaId = 'stepmothers-friends' // stepmothers-friends
