...
describe('Manga4Life Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new MangaLife(cheerio), expect = chai.expect
    ...
    it('Testing search', async () => {
        const testSearch: SearchRequest = {
            ...
            includedTags: [
                //createTag({id: 'type_manhwa', label: 'Manhwa'}),
                //createTag({id: 'genre_fantasy', label: 'Fantasy'})
            ]
        }
