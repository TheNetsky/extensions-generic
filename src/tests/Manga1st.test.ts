...
import { Manga1st } from '../Manga1st/Manga1st'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('Manga1st Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new Manga1st(cheerio)
     ...
     */
    const mangaId = 'ruler-of-infinite-realms' // ruler-of-infinite-realms
