...
import { PlatinumScans } from '../PlatinumScans/PlatinumScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('PlatinumScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new PlatinumScans(cheerio)
     ...
     */
    const mangaId = 'undead-knight' // undead-knight
