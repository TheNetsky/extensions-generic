...
import { Doki1001 } from '../Doki1001/Doki1001'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('Doki1001 Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new Doki1001(cheerio)
     ...
     */
    const mangaId = '%e4%ba%ba%e5%bd%a2%ef%bd%9e%e3%83%92%e3%83%88%e3%82%ac%e3%82%bf%ef%bd%9e-raw-free' // 人形～ヒトガタ～-raw-free
