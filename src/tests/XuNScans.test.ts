...
describe('XuNScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new XuNScans(cheerio)
     ...
     */
    const mangaId = 'the-100-girlfriends-who-really-really-really-really-really-love-you' // The 100 Girlfriends Who Really, Really, Really, Really, Really Love You
