...
import { DankeFursLesen } from '../DankeFursLesen/DankeFursLesen'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('DankeFursLesen Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: GuyaBase = new DankeFursLesen(cheerio)
   ...
   */
    const mangaId = 'xdress-underwear' // xdress-underwearr
    ...
    it('Testing home page results for featured titles', async () => {
        const results = await wrapper.getViewMoreItems(source, 'featured', {}, 1)
