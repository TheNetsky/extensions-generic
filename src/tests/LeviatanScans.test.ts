...
describe('LeviatanScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new LeviatanScans(cheerio)
     ...
     */
    const mangaId = 'the-max-leveled-hero-will-return' // The Max Leveled Hero Will Return!
