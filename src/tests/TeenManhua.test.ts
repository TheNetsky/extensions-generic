...
import { TeenManhua } from '../TeenManhua/TeenManhua'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('TeenManhua Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new TeenManhua(cheerio)
     ...
     */
    const mangaId = 'the-abduction-of-mademoiselle' // the-abduction-of-mademoiselle
