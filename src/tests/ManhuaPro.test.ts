...
import { ManhuaPro } from '../ManhuaPro/ManhuaPro'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('ManhuaPro Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new ManhuaPro(cheerio)
     ...
     */
    const mangaId = 'dr-choi-tae-soo' // dr-choi-tae-soo
