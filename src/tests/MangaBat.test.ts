...
import { MangaBat } from '../MangaBat/MangaBat'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('MangaBat Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new MangaBat(cheerio)
     ...
     */
    const mangaId = 'https://m.mangabat.com/read-oi392249' // The Reincarnated Inferior Magic Swordsman
