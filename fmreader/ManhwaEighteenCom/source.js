...
},{"./FMReaderParser":46,"paperback-extensions-common":7}],46:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhwaEighteenCom = exports.ManhwaEighteenComInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const FMReader_1 = require("../FMReader");
const ManhwaEighteenComParser_1 = require("./ManhwaEighteenComParser");
const ManhwaEighteenCom_DOMAIN = 'https://manhwa18.com';
exports.ManhwaEighteenComInfo = {
    version: '3.0.0',
    name: 'Manhwa18.com',
...
class ManhwaEighteenCom extends FMReader_1.FMReader {
    constructor() {
        super(...arguments);
        this.baseUrl = ManhwaEighteenCom_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.ENGLISH;
        this.parser = new ManhwaEighteenComParser_1.ManhwaEighteenComParser();
        this.requestPath = 'tim-kiem';
        this.popularSort = 'sort=top';
        this.chapterTimeSelector = ".chapter-time";
        this.adult = true;
        this.chapterUrlSelector = '';
        this.chapterDetailsImageSelector = '#chapter-content > img';
        this.sourceTraversalPathName = 'manga';
    }
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (page == -1)
                return createPagedResults({ results: [], metadata: { page: -1 } });
            let request = createRequestObject({
                url: `${this.baseUrl}/${this.requestPath}?q=${query.title ? query.title : ''}&page=${page}${((_b = query === null || query === void 0 ? void 0 : query.includedTags) === null || _b === void 0 ? void 0 : _b.length) !== 0 ? `&accept_genres=${(_c = query === null || query === void 0 ? void 0 : query.includedTags) === null || _c === void 0 ? void 0 : _c.map((x) => x.id)}` : ''}`,
                method: 'GET',
            });
            const data = yield this.requestManager.schedule(request, 2);
            this.CloudFlareError(data.status);
...
exports.ManhwaEighteenCom = ManhwaEighteenCom;

},{"../FMReader":45,"./ManhwaEighteenComParser":48,"paperback-extensions-common":7}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhwaEighteenComParser = void 0;
const FMReaderParser_1 = require("../FMReaderParser");
class ManhwaEighteenComParser extends FMReaderParser_1.Parser {
    parseMangaDetails($, mangaId, source) {
        var _a, _b, _c, _d;
        const title = (_a = this.decodeHTMLEntity($('.series-name').first().text().replace(/manhwa/gi, '').replace(/engsub/gi, '').trim())) !== null && _a !== void 0 ? _a : '';
        const image = (_b = $("meta[property='og:image']").attr("content")) !== null && _b !== void 0 ? _b : 'https://i.imgur.com/GYUxEX8.png';
        let desc = (_c = this.decodeHTMLEntity($('.summary-content').text().trim())) !== null && _c !== void 0 ? _c : '';
        let thumbnail = '';
        if (!image.startsWith('https:')) {
            thumbnail = source.baseUrl + image;
        }
        ...
        if (desc == '')
            desc = `No Decscription provided by the source(${source.baseUrl})`;
        let author = (_d = $('.info-name:contains(Author:) + .info-value').text().trim().replace('Updating', '')) !== null && _d !== void 0 ? _d : '';
    ...
    parseChapters($, mangaId, source) {
        ...
        for (const chapter of $('.list-chapters > a').toArray()) {
            const info = $(chapter);
            const id = (_b = this.idCleaner((_a = info.attr('href')) !== null && _a !== void 0 ? _a : '', source)) !== null && _b !== void 0 ? _b : '';
            const name = (_d = (_c = info.attr('title')) !== null && _c !== void 0 ? _c : info.text().replace(title, '').trim()) !== null && _d !== void 0 ? _d : '';
    ...
    parseTags($) {
        ...
        for (const obj of $(".col-md-6 .form-group .row div").toArray()) {
            genres.push(createTag({
                id: (_a = $("label", obj).attr("data-genre-id")) !== null && _a !== void 0 ? _a : '',
                label: $(obj).text().trim()
            }));
        }
        return genres;
...
exports.ManhwaEighteenComParser = ManhwaEighteenComParser;

},{"../FMReaderParser":46}]},{},[47])(47)
});
