...
const ArangScans_1 = require("../ArangScans/ArangScans");
describe('ArangScans Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new ArangScans_1.ArangScans(cheerio_1.default);
    ...
    it("Get Chapter Details", () => __awaiter(this, void 0, void 0, function* () {
        ...
        let data = yield wrapper.getChapterDetails(source, mangaId, chapters[1].id);
    ...
    it("Testing home page results for latest titles", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "1", {}, 3);
