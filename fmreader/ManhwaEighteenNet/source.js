...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhwaEighteenNet = exports.ManhwaEighteenNetInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const FMReader_1 = require("../FMReader");
const ManhwaEighteenNetPraser_1 = require("./ManhwaEighteenNetPraser");
const ManhwaEighteenNet_DOMAIN = 'https://manhwa18.net';
exports.ManhwaEighteenNetInfo = {
    version: '3.0.0',
    name: 'Manhwa18.net',
...
class ManhwaEighteenNet extends FMReader_1.FMReader {
    constructor() {
        super(...arguments);
        this.baseUrl = ManhwaEighteenNet_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.ENGLISH;
        this.requestPath = 'manga-list.html';
        this.parser = new ManhwaEighteenNetPraser_1.ManhwaEighteenNetParser();
        this.adult = true;
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query.title) {
                ...
                request = createRequestObject({
                    url: `${this.baseUrl}/${(_b = query === null || query === void 0 ? void 0 : query.includedTags) === null || _b === void 0 ? void 0 : _b.map((x) => x.id)[0]}`,
                    method: 'GET',
                });
            }
            const data = yield this.requestManager.schedule(request, 2);
...
exports.ManhwaEighteenNet = ManhwaEighteenNet;

},{"../FMReader":45,"./ManhwaEighteenNetPraser":48,"paperback-extensions-common":7}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhwaEighteenNetParser = void 0;
const FMReaderParser_1 = require("../FMReaderParser");
class ManhwaEighteenNetParser extends FMReaderParser_1.Parser {
    parseTags($) {
        var _a;
        const genres = [];
        for (const obj of $(".col-md-4 .card-body a").toArray()) {
            genres.push(createTag({
                id: encodeURI((_a = $(obj).attr('href')) !== null && _a !== void 0 ? _a : ''),
                label: $(obj).text().trim()
            }));
        }
        return genres;
...
exports.ManhwaEighteenNetParser = ManhwaEighteenNetParser;
