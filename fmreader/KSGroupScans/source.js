...
Object.defineProperty(exports, "__esModule", { value: true });
exports.KSGroupScans = exports.KSGroupScansInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const FMReader_1 = require("../FMReader");
const KSGroupScansPraser_1 = require("./KSGroupScansPraser");
const KSGroupScans_DOMAIN = 'https://ksgroupscans.com';
exports.KSGroupScansInfo = {
    version: '3.0.0',
    name: 'KSGroupScans',
...
class KSGroupScans extends FMReader_1.FMReader {
    constructor() {
        super(...arguments);
        this.baseUrl = KSGroupScans_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.ENGLISH;
        this.requestPath = 'manga-list.html';
        this.parser = new KSGroupScansPraser_1.KSGroupScansParser();
        this.adult = true;
...
exports.KSGroupScans = KSGroupScans;

},{"../FMReader":45,"./KSGroupScansPraser":48,"paperback-extensions-common":7}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KSGroupScansParser = void 0;
const FMReaderParser_1 = require("../FMReaderParser");
class KSGroupScansParser extends FMReaderParser_1.Parser {
    parseTags($) {
        var _a;
        const genres = [];
...
exports.KSGroupScansParser = KSGroupScansParser;
