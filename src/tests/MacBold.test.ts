...
import { MacBold } from '../MacBold/MacBold'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('MacBold Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new MacBold(cheerio)
     ...
     */
    const mangaId = 'substitute-boyfriend' // Substitute Boyfriend
