...
import { MangaOriginesX } from '../MangaOriginesX/MangaOriginesX'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('MangaOriginesX Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new MangaOriginesX(cheerio)
     ...
     */
    const mangaId = '61655705-between-us'
