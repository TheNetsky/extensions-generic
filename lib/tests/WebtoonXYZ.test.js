...
const WebtoonXYZ_1 = require("../WebtoonXYZ/WebtoonXYZ");
describe('WebtoonXYZ Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new WebtoonXYZ_1.WebtoonXYZ(cheerio_1.default);
    ...
    it("Testing Notifications", () => __awaiter(this, void 0, void 0, function* () {
        let updates = yield wrapper.filterUpdatedManga(source, new Date("2021-01-01"), [mangaId]);
